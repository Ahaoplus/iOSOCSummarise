...
#import "RQShineDemoViewController.h"

#import "RQShineLabel.h"

@interface RQShineDemoViewController ()
...
@implementation RQShineDemoViewController
...
- (void)viewDidLoad
{
  [super viewDidLoad];
  self.wallpaper1 = ({
    UIImageView *imageView =  [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"taiji"]];
  ...
  self.wallpaper2 = ({
    UIImageView *imageView =  [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"zhufu"]];
    imageView.contentMode = UIViewContentModeScaleAspectFill;
    imageView.frame = self.view.bounds;
    imageView.alpha = 0;
    imageView;
